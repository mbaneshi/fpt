...
- 🎯 Entry points to execute your program using `python -m <fpt>` or `$ fpt` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/mbaneshi/fpt/branch/main/graph/badge.svg?token=fpt_token_here)](https://codecov.io/gh/mbaneshi/fpt)
[![CI](https://github.com/mbaneshi/fpt/actions/workflows/main.yml/badge.svg)](https://github.com/mbaneshi/fpt/actions/workflows/main.yml)

Awesome fpt created by mbaneshi

## Install

from source
```bash
git clone https://github.com/mbaneshi/fpt fpt
cd fpt
make install
```
...
```bash
❯ fpt --help
Usage: fpt [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fpt create-user --help
Usage: fpt create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fpt create-user admin admin --superuser
```
...
Run with `fpt run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fpt create-user`.
...
-----------------------------------------------------
fpt/__init__.py              4      0   100%
fpt/app.py                  16      1    94%
fpt/cli.py                  21      0   100%
fpt/config.py                5      0   100%
fpt/db.py                   10      0   100%
fpt/models/__init__.py       0      0   100%
fpt/models/content.py       47      1    98%
fpt/routes/__init__.py      11      0   100%
fpt/routes/content.py       52     25    52%
fpt/routes/security.py      15      1    93%
fpt/routes/user.py          52     26    50%
fpt/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fpt/default.toml.
